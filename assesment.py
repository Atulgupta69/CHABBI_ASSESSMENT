...
def get_file_types(extension_type_list, file_list):
    extensions = {}
    for item in extension_type_list.split(';'):
    ...
    for file_name in file_list:
        ...
        if extension in extensions:
            file_types[file_name] = extensions[extension]
        else:
...
def date_difference_less_than(from_date, to_date, difference):
    date_format = '%y-%m-%d'
...
def get_date_before(date, n):
    ...
    before_date = given_date - timedelta(days=n)
